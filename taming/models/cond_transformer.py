...
from VQGAN.taming.modules.util import SOSProvider
...
class Net2NetTransformer(pl.LightningModule):
    def __init__(self,
        ...
        if permuter_config is None:
            permuter_config = {"target": "taming.modules.comparison.permuter.Identity"}
    ...
    def sample(self, x, c, steps, temperature=1.0, sample=False, top_k=None,
        ...
        if self.pkeep <= 0.0:
            ...
            #noise = torch.randint(self.comparison.config.vocab_size, noise_shape).to(x)
